import { View, Text, Image, Pressable, Animated, TouchableOpacity, BackHandler, Alert } from "react-native";
...
export default function RegisterPhoto() {
    ...
    const registerUser = async () => {
        try {
            ...
            const response = await axios.post('https://048f-2804-7f0-b900-b8bd-1c99-2c4d-1967-309c.ngrok-free.app/api/users', {
                name,
                email,
                password,
                number,
